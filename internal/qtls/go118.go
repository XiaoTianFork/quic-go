...
import (
	...
	"github.com/xiaotianfork/qtls-go1-18"
)
...
func LoadX509KeyPair(certFile, keyFile string) (qtls.Certificate, error) {
	return qtls.LoadX509KeyPair(certFile, keyFile)
}

//go:linkname cipherSuiteTLS13ByID github.com/xiaotianfork/qtls-go1-18.cipherSuiteTLS13ByID
